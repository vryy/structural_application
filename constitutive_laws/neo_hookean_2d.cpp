...
//**********************************************************************
bool NeoHookean2D::Has( const Variable<int>& rThisVariable ) const
{
    return false;
}

//**********************************************************************
bool NeoHookean2D::Has( const Variable<double>& rThisVariable ) const
{
...
//**********************************************************************
bool NeoHookean2D::Has( const Variable<Vector>& rThisVariable ) const
{
...
//**********************************************************************
bool NeoHookean2D::Has( const Variable<Matrix>& rThisVariable ) const
{
    return false;
}
